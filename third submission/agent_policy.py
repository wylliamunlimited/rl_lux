...
class AgentPolicy(AgentWithModel):
    ...
    def get_reward(self, game, is_game_finished, is_new_turn, is_game_error):
        ...
        rewards["rew/r_wood_collected"] = ( (wood_collected - self.wood_collected_last) / 10000 )
        ...
        rewards["rew/r_coal_collected"] = ( (coal_collected - self.coal_collected_last) / 1000 )
        ...
        rewards["rew/r_uranium_collected"] = ( (uranium_collected - self.uranium_collected_last) / 100 )
        ...
        rewards["rew/r_fuel_generated"] = ( (fuel_generated - self.fuel_generated_last) / 20000 )
